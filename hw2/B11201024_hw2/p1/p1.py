    ...
    if args.feature == 'tiny_image':
        ...
        if os.path.isfile(vocab_name) is False:
            ...
            with open(vocab_name, 'rb') as f:
                vocab = pickle.load(f)
        # train_image_feats
        train_img_feats_name = f'train_image_feats.pkl'
        if os.path.isfile(train_img_feats_name) is False:
            ...
            with open(train_img_feats_name, 'rb') as f:
                train_img_feats = pickle.load(f)
        # test_image_feats
        test_img_pkl_paths = f'test_image_feats.pkl'
        if os.path.isfile(test_img_pkl_paths) is False:
            ...
            with open(test_img_pkl_paths, 'rb') as f:
